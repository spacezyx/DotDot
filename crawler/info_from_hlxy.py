...
def getallcontent(url,txtname):
    ...
    txt = open("./"+path+"/"+path+"-"+txtname+".txt", "a",encoding='utf-8').write("详情链接\n")
    txt = open("./"+path+"/"+path+"-"+txtname+".txt", "a",encoding='utf-8').write(str(url))
...
if __name__=='__main__':
    getdetailurl("https://news.sjtu.edu.cn/hlxy/index.html",details_url)
    ...
    for i in range(2,14):
        getdetailurl("https://news.sjtu.edu.cn/hlxy/index_"+str(i)+".html",details_url)
