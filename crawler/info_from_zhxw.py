...
if __name__=='__main__':
    getdetailurl("https://news.sjtu.edu.cn/zhxw/index.html",details_url)
    ...
    for i in range(2,100):
        getdetailurl("https://news.sjtu.edu.cn/zhxw/index_"+str(i)+".html",details_url)
