...
findTime = re.compile(r'class="Article-time">(.*?)</small>') #时间
...
def getdetailurl(url,details_url):
    ...
    for item in datalist:
        ...
        if('http' in new_url):
            ...
            details_url.append("https://www.sjtu.edu.cn"+item)
...
if __name__=='__main__':
    getdetailurl("https://www.sjtu.edu.cn/tg/index.html",details_url)
    ...
    for i in range(2,43):
        getdetailurl("https://www.sjtu.edu.cn/tg/index_"+str(i)+".html",details_url)
