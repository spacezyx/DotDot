...
if __name__=='__main__':
    ...
    getdetailurl("https://news.sjtu.edu.cn/jdyw/index.html",details_url)
    ...
    for i in range(2,101):
        getdetailurl("https://news.sjtu.edu.cn/jdyw/index_"+str(i)+".html",details_url)
