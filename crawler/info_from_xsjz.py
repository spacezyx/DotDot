...
if __name__=='__main__':
    ...
    getdetailurl("https://news.sjtu.edu.cn/xsjz/index.html",details_url)
    ...
    for i in range(2,50):
        getdetailurl("https://news.sjtu.edu.cn/xsjz/index_"+str(i)+".html",details_url)
