...
public class RobotDaoImplTest {
    // 要mock的对象
    @Mock
    private RobotRepository robotDao;

    // 被mock的对象的使用者
    @InjectMocks
    private RobotDaoImpl robotService;
    ...
    public void addRobot() {
        String APISecret = robotService.addRobot(1,"name","apikey","last","establish",true,200,1);
        Mockito.verify(robotDao).addRobot(1,"name","apikey","last","establish",true,200,APISecret,1);
    }
